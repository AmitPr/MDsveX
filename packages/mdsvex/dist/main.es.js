...
import fs from 'fs';
import { parse as parse$8 } from 'svelte/compiler';
...
const code_highlight = (code, lang, metastring) => {
...
export { _compile as compile, defineConfig as defineMDSveXConfig, escape_svelty as escapeSvelte, mdsvex };
